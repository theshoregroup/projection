	...
	"group/bubble relative flex w-fit min-w-0 max-w-[80%] flex-col gap-1 data-[variant=ghost]:max-w-full data-[align=end]:self-end group-data-[align=end]/message:self-end",
	{
		variants: {
			variant: {
				...
				destructive:
					"*:data-[slot=bubble-content]:bg-destructive/60 *:data-[slot=bubble-content]:text-destructive-foreground [&>[data-slot=bubble-content]:is(button,a):hover]:bg-destructive/70",
			},
		},
		defaultVariants: {
			variant: "default",
